...
Brings the Jython language compiler and libraries
-------------------------------------------------

Plugin page: [http://artifacts.griffon-framework.org/plugin/jython](http://artifacts.griffon-framework.org/plugin/jython)
